...
def handle_lot(lot):
    ...
    theo_parent_lot = CarbureLot.objects.get(volume=old_tx.parent_tx.lot.volume, transport_document_reference=old_tx.parent_tx.dae, carbure_client=lot.carbure_supplier)
