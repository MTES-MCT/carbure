...
export const okSnapshot = rest.get("/api/transactions/snapshot", (req, res, ctx) => {
  return res(
    ctx.json({
      status: "success",
...
export const okDeclarations = rest.get("/api/transactions/declarations", (req, res, ctx) => {
  return res(
    ctx.json({
      status: "success",
      data: [
...
export const okFilters = rest.get("/api/transactions/lots/filters", (req, res, ctx) => {
  return res(
    ctx.json({
      status: "success",
...
export const okSummary = rest.get("/api/transactions/lots/summary", (req, res, ctx) => {
  return res(
    ctx.json({
      status: "success",
