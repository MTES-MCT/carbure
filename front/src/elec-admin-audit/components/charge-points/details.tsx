    ...
    <Portal onClose={closeDialog}>
      <Dialog onClose={closeDialog} >
        ...
        <footer>
          ...
          {chargePointApplication?.status === ElecChargePointsApplicationStatus.AuditInProgress && (
            <>
              <MailtoButton cpo={chargePointApplication.cpo} chargePointCount={chargePointApplication.charge_point_count} emailContact={chargePointApplication.email_contact} />
...
const MailtoButton = ({ cpo, chargePointCount, emailContact }: { cpo: EntityPreview, chargePointCount: number, emailContact: string }) => {
  const { t } = useTranslation()
  ...
  const mailto = `mailto:${emailContact}?subject=${encodeURIComponent(subject)}&body=${bodyIntro + bodyContent + bodyOutro}`
