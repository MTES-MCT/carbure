...
=======
>>>>>>> 75f64aae5 (fix(iricc): no longer use 'date_from' param and 'created_at' info in balance calculation, but use 'declaration_year')
=======
>>>>>>> 33565927a (chore(api): update schema)
    schemas: {
        AcceptRequest: {
...
=======
  schemas: {
    ...
    Action: {
      ...
      readonly site: components["schemas"]["ActionSite"]
      readonly certificate: components["schemas"]["ActionCertificate"] | null
      readonly total_emissions:
        | components["schemas"]["ActionTotalEmissions"]
        | null
      /** N° de POS */
      pos_id: string
      /** Filière */
    ...
    BiomethaneAdminAnnualDeclaration: {
      readonly status: components["schemas"]["BiomethaneAnnualDeclarationStatusEnum"]
      readonly producer: components["schemas"]["EntityPreview"]
      readonly tariff_reference:
        | components["schemas"]["TariffReferenceEnum"]
        | null
      /** Format: date */
      readonly effective_date: string | null
      readonly department: string | null
    ...
    BiomethaneContract: {
      ...
      installation_category?:
        | components["schemas"]["InstallationCategoryEnum"]
        | null
      /**
       * Cmax (Nm³/h)
       * Format: double
    ...
    BiomethaneProductionUnit: {
      ...
      hygienization_exemption_type?:
        | components["schemas"]["HygienizationExemptionTypeEnum"]
        | null
      /** N° ICPE */
      ...
      methanization_process?:
        | components["schemas"]["MethanizationProcessEnum"]
        | null
      /**
    ...
    ElecProvisionCertificateQualichargeResponse:
      | components["schemas"]["ElecProvisionCertificateQualichargeGrouped"]
      | components["schemas"]["ElecProvisionCertificateQualicharge"]
    /**
    ...
    TariffCoefficientProportions: {
      readonly tariff_coefficients:
        | components["schemas"]["TariffCoefficients"]
        | null
      /** Format: double */
...
>>>>>>> cf17182b3 (chore(api): update schema)
=======
>>>>>>> 57ac78e30 (fix(iricc): no longer use 'date_from' param and 'created_at' info in balance calculation, but use 'declaration_year')
>>>>>>> 75f64aae5 (fix(iricc): no longer use 'date_from' param and 'created_at' info in balance calculation, but use 'declaration_year')
=======
>>>>>>> 33565927a (chore(api): update schema)
        /**
