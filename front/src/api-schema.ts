export interface paths {
    ...
    "/api/biomethane/injection-site/": {
        ...
        post: operations["biomethane_injection_site_create"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
...
export interface components {
    schemas: {
        ...
        BiomethaneInjectionSiteRequest: {
            unique_identification_number: string;
            is_shared_injection_site?: boolean;
            meter_number?: string | null;
            is_different_from_production_site?: boolean;
...
export interface operations {
    ...
    biomethane_injection_site_update: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["BiomethaneInjectionSiteRequest"];
                "application/x-www-form-urlencoded": components["schemas"]["BiomethaneInjectionSiteRequest"];
                "multipart/form-data": components["schemas"]["BiomethaneInjectionSiteRequest"];
            };
        };
        responses: {
            200: {
    ...
    biomethane_injection_site_create: {
        parameters: {
            query: {
                /** @description Authorised entity ID. */
                entity_id: number;
        ...
        responses: {
            201: {
                ...
                content: {
                    "application/json": components["schemas"]["BiomethaneInjectionSiteInput"];
                };
            };
        };
    };
