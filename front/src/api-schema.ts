...
export interface components {
  schemas: {
    ...
    BiomethaneProductionUnit: {
      ...
      sanitary_approval_number: string
      has_hygienization_exemption?: boolean
      hygienization_exemption_type: components["schemas"]["HygienizationExemptionTypeEnum"]
      icpe_number: string
      icpe_regime: components["schemas"]["IcpeRegimeEnum"]
      process_type: components["schemas"]["ProcessTypeEnum"]
      methanization_process: components["schemas"]["MethanizationProcessEnum"]
      /** Format: double */
      ...
      raw_digestate_treatment_steps: string
      liquid_phase_treatment_steps: string
      solid_phase_treatment_steps: string
      digestate_valorization_method: components["schemas"]["DigestateValorizationMethodEnum"]
      spreading_management: components["schemas"]["SpreadingManagementEnum"]
      digestate_sale_type: components["schemas"]["DigestateSaleTypeEnum"]
    }
...
export interface operations {
  ...
  biomethane_contract_amendments_retrieve: {
    parameters: {
      ...
      header?: never
      path: {
        /** @description A unique integer value identifying this Biométhane - Avenant. */
        id: number
      }
      cookie?: never
    }
