...
import banner from "common/assets/images/banner.light.webp"
import traders from "common/assets/images/traders.svg"
import operators from "common/assets/images/operators.svg"
import schema from "common/assets/images/schema.svg"
...
const Home = () => {
  ...
  const stats = useQuery(() => api.get<Api<HomeStats>>("/home-stats"), {
    key: "stats",
    params: [],
  })
