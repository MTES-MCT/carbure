...
import {
  ...
  elecAdminMeterReadingsApplicationsList,
  elecAuditAdminMeterReadingsFilters,
} from "./data"
...
export const okGenerateSample = mockPostWithResponseData(
  "/elec/admin/audit/charge-points/generate-sample",
  elecAuditApplicationSample
)
export const okStartChargePointsApplicationAudit = mockPostWithResponseData(
  "/elec/admin/audit/charge-points/start-audit"
)

/*** Meter readings ***/
export const okGetMeterReadingsApplications = mockGetWithResponseData(
  "/elec/admin/audit/meter-readings/applications",
  elecAdminMeterReadingsApplicationsList
)
export const okGetMeterReadingsApplicationsFilters = mockGetWithResponseData(
  "/elec/admin/audit/meter-readings/filters",
  elecAuditAdminMeterReadingsFilters
)
export const okGetMeterReadingsApplicationDetails = mockGetWithResponseData(
...
export const okMeterReadingsGenerateSample = mockPostWithResponseData(
  "/elec/admin/audit/meter-readings/generate-sample",
  elecAuditApplicationSample
)
export const okStartMeterReadingsApplicationAudit = mockPostWithResponseData(
  "/elec/admin/audit/meter-readings/start-audit"
)
