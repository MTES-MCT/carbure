...
export const MeterReadingsApplicationDetailsPending = ({
  ...
  const startAudit = async (
    ...
    startMeterReadingsApplicationAuditMutation
      .execute(entityId, applicationId)
      .then(() => {
        notify(
          t(
            "L'audit des relevés des {{count}} points de recharge a bien été initié.",
      ...
      .catch((err) => {
        notifyError(
          err,
          t("Impossible d'initier l'audit des relevés des points de recharge.")
        )
      })
  }
    ...
    <>
      <ApplicationSampleGeneration
        ...
        startAuditQueryLoading={
          startMeterReadingsApplicationAuditMutation.loading
        }
