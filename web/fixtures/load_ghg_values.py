...
with open(filename) as csvfile:
    ...
    next(reader)
    for row in reader:
        # header code_biocarburant,biocarburant,code_matiere_premiere,matiere_premiere,condition,eec_typical,
        # eec_default,ep_typical,ep_default,etd_typical,etd_default
        ...
        obj, created = GHGValues.objects.update_or_create(matiere_premiere=mp, biocarburant=bc, condition=condition,
                                                          defaults=d)
