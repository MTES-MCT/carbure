...
try:
    robot = usermodel.objects.get(name='MTE Robot 2015')
except:
    usermodel.objects.create_user(name='MTE Robot 2015', email='robot2015@carbure.beta.gouv.fr')
    robot = usermodel.objects.get(name='MTE Robot 2015')
...
filename = '%s/web/fixtures/2015lotsv2.xlsx' % (os.environ['CARBURE_HOME'])
