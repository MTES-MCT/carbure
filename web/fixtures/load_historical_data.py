...
def load_lot(lot):
    ...
    if lc is not None and lc != '':
        ...
        if 'FR' in dae:
            ...
            if lot['double_counting_registration'] is not None and isinstance(lot['double_counting_registration'], str) and lot['double_counting_registration'][0:2] in countries:
    ...
    try:
        ...
        print(lot)
        return
    d = {'period': dd.year * 100 + dd.month, 'year': dd.year,
         'carbure_producer': None, 'unknown_producer': '',
         'carbure_production_site': None, 'unknown_production_site': '',
...
def load_histo_data():
    files = [(2018, '2018lotsv2.xlsx'), (2017, '2017lotsv2.xlsx'), (2016, '2016lotsv2.xlsx'), (2015, '2015lotsv2.xlsx'), (2014, '2014lotsv2.xlsx')]
    for year, f in files:
