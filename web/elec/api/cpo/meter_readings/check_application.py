...
def get_application_quarter(reference_date: date):
    ...
    is_second_quarter_2024 = quarter == 2 and reference_date.year == 2024
    ...
    if (reference_date - first_day_of_quarter).days <= 20 or is_first_quarter_2024 or is_second_quarter_2024:
