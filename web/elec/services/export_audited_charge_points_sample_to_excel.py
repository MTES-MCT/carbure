        ...
        [
            {
                ...
                "columns": [
                    ...
                    {
                        "label": "Infrastructure de recharge installée à la localisation renseignée (OUI/NON)",
                        "value": "is_auditable",
                    },
                    {
                        "label": "Identifiant renseigné visible à proximité immédiate de l'infrastructure (OUI/NON)",
                        "value": "has_dedicated_pdl",
                    },
                    {"label": "Point de contrôle type de courant (CA ou CC)", "value": "current_type"},
                    {"label": "Date du relevé par l'intervenant (JJ/MM/AAAA)", "value": "audit_date"},
                    {"label": "Énergie active totale relevée (kWh)", "value": "observed_energy_reading"},
                    {"label": "Limite dans la mission de contrôle (commentaire)", "value": "comment"},
                ],
            }
        ],
