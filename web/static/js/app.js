...
{title:'Producteur', hidden: true, can_filter: true, filter_title: 'Producteur', can_hide: true, render: (data, type, full, meta) => { return full.fields.carbure_producer ? full.fields.carbure_producer.name : `<i>${full.fields.unknown_producer}</i>` }},
{title:'Site de<br /> Production', can_filter: true, filter_title: 'Site', can_hide: true, can_filter: true, orderable: false, render: (data, type, full, meta) => { return full.fields.carbure_production_site ? full.fields.carbure_production_site.name : `<i>${full.fields.unknown_production_site}</i>` }},
...
{title:'Client', can_hide: true, can_filter: true, orderable: false, render: (data, type, full, meta) => {return full.tx.fields.carbure_client ? full.tx.fields.carbure_client.name : `<i>${full.tx.fields.unknown_client}</i>`}},
{title:'Site de livraison', can_hide: true, can_filter: true, orderable: false, render: (data, type, full, meta) => {return full.tx.fields.carbure_delivery_site ? full.tx.fields.carbure_delivery_site.name : `<i>${full.tx.fields.unknown_delivery_site}</i>` }},
]
...
{title:'Producteur', hidden: true, can_hide: true, render: (data, type, full, meta) => { return full.fields.producer_is_in_carbure ? full.fields.carbure_producer.name : `<i>${full.fields.unknown_producer}</i>` }},
{title:'Site de<br /> Production', filter_title: 'Site', can_hide: true, can_filter: true, orderable: false, render: (data, type, full, meta) => { return full.fields.production_site_is_in_carbure ? full.fields.carbure_production_site.name : `<i>${full.fields.unknown_production_site}</i>` }},
{title:'Pays de<br /> Production', filter_title: 'Pays Production', can_hide: true, can_filter: true, orderable: false, render: (data, type, full, meta) => { return full.fields.production_site_is_in_carbure ? full.fields.carbure_production_site.country.code_pays : (full.fields.unknown_production_country ? full.fields.unknown_production_country.code_pays: "") }},
{title:'Volume<br /> à 20°C<br /> en Litres', can_hide: true, data: 'volume'},
...
{title:`Pays<br /> d'origine`, filter_title: 'Pays', can_hide: true, can_filter: true, orderable: false, render: (data, type, full, meta) => { return full.fields.pays_origine.code_pays }},
{title:'E', can_hide: true, is_read_only: true, data: 'ghg_total', tooltip: 'Total des émissions résultant de l\'utilisation du carburant'},
{title:'% de réduction', can_hide: true, is_read_only: true, data: 'ghg_reduction'},
{title:'N°Document douanier', can_hide: true, render: (data, type, full, meta) => {return full.tx.fields.dae}},
{title:'Champ libre', can_hide: true, can_filter: true, orderable: false, tooltip: 'Champ libre - Référence client', render: (data, type, full, meta) => {return full.tx.fields.champ_libre}},
{title:'Date de livraison', can_hide: true, render: (data, type, full, meta) => {return full.tx.fields.delivery_date}},
{title:'Client', can_hide: true, can_filter: true, orderable: false, render: (data, type, full, meta) => {return full.tx.fields.client_is_in_carbure ? full.tx.fields.carbure_client.name : `<i>${full.tx.fields.unknown_client}</i>`}},
{title:'Site de livraison', can_hide: true, can_filter: true, orderable: false, render: (data, type, full, meta) => {return full.tx.fields.delivery_site_is_in_carbure ? full.tx.fields.carbure_delivery_site.name : `<i>${full.tx.fields.unknown_delivery_site}</i>` }},
{title:'Status', can_hide: true, can_filter: true, orderable: true, render: (data, type, full, meta) => {return full.tx.fields.delivery_status}},
]
...
{title:'<input name="select_all" value="1" type="checkbox">', can_hide: false, read_only: true, data:'checkbox'},
{title:'Numéro de lot', can_hide: true, data:'carbure_id'},
{title:'Producteur', hidden: true, can_hide: true, render: (data, type, full, meta) => { return full.fields.carbure_producer ? full.fields.carbure_producer.name : `<i>${full.fields.unknown_producer}</i>` }},
{title:'Site de<br /> Production', filter_title: 'Site', can_hide: true, can_filter: true, orderable: false, render: (data, type, full, meta) => { return full.fields.carbure_production_site ? full.fields.carbure_production_site.name : `<i>${full.fields.unknown_production_site}</i>` }},
{title:'Pays de<br /> Production', filter_title: 'Pays Production', can_hide: true, can_filter: true, orderable: false, render: (data, type, full, meta) => { return full.fields.carbure_production_site ? full.fields.carbure_production_site.country.code_pays : (full.fields.unknown_production_country ? full.fields.unknown_production_country.code_pays: "") }},
{title:'Fournisseur', can_hide: true, render: (data, type, full, meta) => { return full.tx.fields.carbure_vendor ? full.tx.fields.carbure_vendor.name : `<i>${full.tx.fields.unknown_vendor}</i>` }},
{title:'Volume<br /> à 20°C<br /> en Litres', can_hide: true, data: 'volume'},
{title:'Biocarburant', can_hide: true, can_filter: true, orderable: false, render: (data, type, full, meta) => { return full.fields.biocarburant.name }},
{title:'Matière<br /> Première', filter_title:'MP', can_hide: true, can_filter: true, orderable: false, render: (data, type, full, meta) => { return full.fields.matiere_premiere.name }},
{title:`Pays<br /> d'origine`, filter_title: 'Pays', can_hide: true, can_filter: true, orderable: false, render: (data, type, full, meta) => { return full.fields.pays_origine.code_pays }},
...
{title:'Numéro de lot', can_hide: true, data:'carbure_id'},
{title:'Producteur', hidden: true, can_hide: true, render: (data, type, full, meta) => { return full.fields.carbure_producer ? full.fields.carbure_producer.name : `<i>${full.fields.unknown_producer}</i>` }},
{title:'Site de<br /> Production', hidden: true, filter_title: 'Site', can_hide: true, can_filter: true, orderable: false, render: (data, type, full, meta) => { return full.fields.carbure_production_site ? full.fields.carbure_production_site.name : `<i>${full.fields.unknown_production_site}</i>` }},
...
{title:'Site de stockage', can_hide: true, can_filter: true, orderable: false, render: (data, type, full, meta) => {return full.tx.fields.delivery_site_is_in_carbure ? full.tx.fields.carbure_delivery_site.name : `<i>${full.tx.fields.unknown_delivery_site}</i>` }},
]
...
{title:'Client', can_hide: true, can_filter: true, orderable: false, render: (data, type, full, meta) => {return full.fields.carbure_client ? full.fields.carbure_client.name : `<i>${full.fields.unknown_client}</i>`}},
{title:'Site de livraison', can_hide: true, can_filter: true, orderable: false, render: (data, type, full, meta) => {return full.fields.carbure_delivery_site ? full.fields.carbure_delivery_site.name : `<i>${full.fields.unknown_delivery_site}</i>` }},
]
...
{title:'Producteur', can_hide: true, render: (data, type, full, meta) => { return full.fields.carbure_producer ? full.fields.carbure_producer.name : `<i>${full.fields.unknown_producer}</i>` }},
{title:'Site de<br /> Production', hidden:true, filter_title: 'Site', can_hide: true, can_filter: true, orderable: false, render: (data, type, full, meta) => { return full.fields.carbure_production_site ? full.fields.carbure_production_site.name : `<i>${full.fields.unknown_production_site}</i>` }},
{title:'Fournisseur', hidden: true, can_hide: true, render: (data, type, full, meta) => { return full.tx.fields.carbure_vendor ? full.tx.fields.carbure_vendor.name : `<i>${full.tx.fields.unknown_vendor}</i>` }},
{title:'Date d\'entrée<br /> en EA', can_hide: true, render: (data, type, full, meta) => {return full.tx.fields.delivery_date}},
{title:'Client', can_hide: true, can_filter: true, orderable: false, render: (data, type, full, meta) => {return full.tx.fields.carbure_client ? full.tx.fields.carbure_client.name : `<i>${full.tx.fields.unknown_client}</i>`}},
{title:'Site de livraison', can_hide: true, can_filter: true, orderable: false, render: (data, type, full, meta) => {return full.tx.fields.delivery_site_is_in_carbure ? full.tx.fields.carbure_delivery_site.name : `<i>${full.tx.fields.unknown_delivery_site}</i>` }},
{title:'Volume<br /> à 20°C<br /> en Litres', can_hide: true, data: 'volume'},
...
{title:'Producteur', can_hide: true,  can_filter: true, orderable: false, data:'producer_name'},
...
{title:'Matière<br /> Première', can_hide: true,  can_filter: true, orderable: false, data: 'matiere_premiere_name'},
{title:`Pays<br /> d'origine`, can_hide: true,  can_filter: true, orderable: false, data: 'pays_origine_name'},
...
{title:'Date d\'entrée<br />en EA', can_hide: true,  data:'ea_delivery_date'},
...
function display_generic_lot_received_modal(table, columns, event) {
  // check if we clicked on the checkbox
  let colid = event.target._DT_CellIndex.column
  let rowid = event.target._DT_CellIndex.row
  let data = table.row(rowid).data()
...
const dt_received_config = {
  ...
  post_init: function(table) {
    let tbl_id = table.table().node().id
    $(`#${tbl_id} tbody`).on('click', 'td',  (e) => {
      display_generic_lot_received_modal(table, table_columns_received_v2, e)
    })
    $('#input_search_datatable').on('keyup', function() {
        table.search(this.value).draw();
    })
...
const dt_operators_drafts_config = {
  ...
  columnDefs: [
    ...
    },
    {
      ...
      targets: "_all",
      render: function (data, type, full, meta) {
        let col_name = operators_table_columns_drafts_v2[meta.col].data
        if (operators_table_columns_drafts_v2[meta.col]['render'] != undefined) {
      return operators_table_columns_drafts_v2[meta.col]['render'](full)
        }
        return full['fields'][col_name]
      }
    },
  ...
  post_init: function(table) {
    let tbl_id = table.table().node().id
    $(`#${tbl_id} tbody`).on('click', 'td',  (e) => {
      display_producers_lot_draft_modal(table, operators_table_columns_drafts_v2, e)
    })
    $('#input_search_datatable').on('keyup', function() {
        table.search(this.value).draw();
    })
