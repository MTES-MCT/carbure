...
def get_distance(a, b):
    ...
    url = (
        """https://wxs.ign.fr/calcul/geoportail/itineraire/rest/1.0.0/route?resource=bdtopo-osrm&start=%s&end=%s&profile=car&optimization=fastest&constraints=%%7B%%22constraintType%%22%%3A%%22banned%%22%%2C%%22key%%22%%3A%%22wayType%%22%%2C%%22operator%%22%%3A%%22%%3D%%22%%2C%%22value%%22%%3A%%22autoroute%%22%%7D&getSteps=false&getBbox=false&distanceUnit=kilometer&timeUnit=hour&crs=EPSG%%3A4326"""
        % (s, e)
    )
