    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "correction_status",
                    models.CharField(
                        choices=[("NO_PROBLEMO", "NO_PROBLEMO"), ("IN_CORRECTION", "IN_CORRECTION"), ("FIXED", "FIXED")],
                        default="NO_PROBLEMO",
                        max_length=64,
                    ),
                ),
                ...
                (
                    "audit_status",
                    models.CharField(
                        choices=[("UNKNOWN", "UNKNOWN"), ("CONFORM", "CONFORM"), ("NONCONFORM", "NONCONFORM")],
                        default="UNKNOWN",
                        max_length=24,
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "comment_type",
                    models.CharField(
                        choices=[("REGULAR", "REGULAR"), ("AUDITOR", "AUDITOR"), ("ADMIN", "ADMIN")],
                        default="REGULAR",
                        max_length=16,
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "transformation_type",
                    models.CharField(
                        choices=[("UNKNOWN", "UNKNOWN"), ("ETH_ETBE", "ETH_ETBE")], default="UNKNOWN", max_length=32
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "preferred_unit",
                    models.CharField(choices=[("l", "litres"), ("kg", "kg"), ("MJ", "MJ")], default="l", max_length=64),
                ),
            ],
            options={
                "verbose_name": "Entity",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "ownership_type",
                    models.CharField(
                        choices=[("OWN", "Propre"), ("THIRD_PARTY", "Tiers"), ("PROCESSING", "Processing")],
                        default="THIRD_PARTY",
                        max_length=32,
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "right",
                    models.CharField(
                        choices=[("DCA", "DCA"), ("AGRIMER", "AGRIMER"), ("TIRIB", "TIRIB")], default="", max_length=32
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "lot",
                    models.ForeignKey(
                        blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to="core.carburelot"
                    ),
                ),
            ],
            options={
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name="blender", to="core.entity"
            ),
        ),
        migrations.AddField(
            model_name="entitydepot",
        ...
        migrations.AddField(
            ...
            name="dest_stock",
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE, related_name="dest_stock", to="core.carburestock"
            ),
        ),
        migrations.AddField(
            model_name="carburestocktransformation",
        ...
        migrations.AddField(
            ...
            name="source_stock",
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE, related_name="source_stock", to="core.carburestock"
            ),
        ),
        migrations.AddField(
            model_name="carburestocktransformation",
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                ...
                related_name="stock_carbure_client",
                to="core.entity",
            ),
        ),
    ]
