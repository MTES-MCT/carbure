    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('transport_document_reference', models.CharField(default=None, max_length=64)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('event_type', models.CharField(choices=[('CREATED', 'CREATED'), ('UPDATED', 'UPDATED'), ('VALIDATED', 'VALIDATED'), ('FIX_REQUESTED', 'FIX_REQUESTED'), ('MARKED_AS_FIXED', 'MARKED_AS_FIXED'), ('FIX_ACCEPTED', 'FIX_ACCEPTED'), ('ACCEPTED', 'ACCEPTED'), ('DECLARED', 'DECLARED'), ('DELETED', 'DELETED'), ('RESTORED', 'RESTORED')], max_length=32)),
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=['lot'], name='carbure_lot_lot_id_5f1cca_idx'),
        ),
        migrations.AddIndex(
            model_name='carburelot',
