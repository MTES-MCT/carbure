...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AlterField(
            ...
            name='added_by',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='saf_source_owner', to='core.entity'),
        ),
        migrations.AlterField(
            model_name='safticketsource',
            name='carbure_producer',
            field=models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='saf_source_producer', to='core.entity'),
        ),
        migrations.AlterField(
            model_name='safticketsource',
            name='country_of_origin',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='saf_source_origin_country', to='core.pays'),
        ),
        migrations.AlterField(
            model_name='safticketsource',
            name='production_country',
            field=models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='saf_source_production_country', to='core.pays'),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('added_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='saf_owner', to='core.entity')),
                ...
                ('carbure_production_site', models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='saf_production_site', to='producers.productionsite')),
                ('client', models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.SET_NULL, to='core.entity')),
                ...
                ('parent_ticket_source', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='saf_ticket', to='saf.safticketsource')),
