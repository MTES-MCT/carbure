...
from biomethane.models import BiomethaneProductionUnit, BiomethaneSupplyInput, BiomethaneSupplyPlan
...
class BiomethaneSupplyInputExportSerializer(serializers.ModelSerializer):
    ...
    producer = EntityPreviewSerializer(source="supply_plan.producer")
    production_unit = BiomethaneProductionUnitSerializer(source="supply_plan.producer.biomethane_production_unit")
