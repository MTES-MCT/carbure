...
from biomethane.services.supply_plan.supply_input import apply_feedstock_field_rules
from core.models import MatierePremiere
from feedstocks.models import Classification


class ApplyFeedstockFieldRulesTests(TestCase):
    """Tests for apply_feedstock_field_rules()."""
