from biomethane.services.consistency_checks.types import ConsistencyCheck, Severity


class BiomethaneEnergyConsistencyChecksService:
    @classmethod
    def get_consistency_warnings(cls, instance) -> list[ConsistencyCheck]:
        warnings: list[ConsistencyCheck] = []
    ...
    @staticmethod
    def _check_injected_biomethane_ch4_rate_percent(instance) -> ConsistencyCheck | None:
