...
def send_email_to_admin_users(entity, depot, admins, request):
    ...
    Rendez-vous sur la page Société pour ajouter le dépôt à votre liste ou cliquez sur le lien suivant : {environ.get('PUBLIC_URL')}/org/{entity.id}/settings/depot
