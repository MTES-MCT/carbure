...
class EntityProductionSiteTest(TestCase):
    ...
    def setUp(self):
        ...
        self.entity2, _ = Entity.objects.update_or_create(
            name="Le Super Operateur 1", entity_type="Opérateur"
        )
        UserRights.objects.update_or_create(
            user=self.user, entity=self.entity2, defaults={"role": UserRights.ADMIN}
        )

        self.entity3, _ = Entity.objects.update_or_create(
            name="Le Super Trader 1", entity_type="Trader"
        )
        UserRights.objects.update_or_create(
            user=self.user, entity=self.entity2, defaults={"role": UserRights.ADMIN}
        )
    ...
    def test_mac_option(self):
        ...
        response = self.client.post(
            reverse(url), {"entity_id": "blablabla", "has_mac": "true"}
        )
        ...
        response = self.client.post(
            reverse(url), {"entity_id": self.entity3.id, "has_mac": "true"}
        )
        self.assertEqual(response.status_code, 403)
        # rights RW, mac option OK
        response = self.client.post(
            reverse(url), {"entity_id": self.entity2.id, "has_mac": "true"}
        )
        ...
        # should pass
        response = self.client.post(
            reverse(url), {"entity_id": self.entity1.id, "has_mac": "true"}
        )
        self.assertEqual(response.status_code, 200)
        ...
        # wrongly formatted
        response = self.client.post(
            reverse(url), {"entity_id": "blablabla", "has_mac": "false"}
        )
        self.assertEqual(response.status_code, 403)
        # no entity_id
        ...
        # entity I do not belong to
        response = self.client.post(
            reverse(url), {"entity_id": self.entity3.id, "has_mac": "false"}
        )
        self.assertEqual(response.status_code, 403)
        # should pass
        response = self.client.post(
            reverse(url), {"entity_id": self.entity1.id, "has_mac": "false"}
        )
        self.assertEqual(response.status_code, 200)
        entity = Entity.objects.get(id=self.entity1.id)
    ...
    def test_trading_option(self):
        ...
        # wrongly formatted
        response = self.client.post(
            reverse(url), {"entity_id": "blablabla", "has_trading": "true"}
        )
        self.assertEqual(response.status_code, 403)
        # no entity_id
        ...
        # entity I do not belong to
        response = self.client.post(
            reverse(url), {"entity_id": self.entity3.id, "has_trading": "true"}
        )
        self.assertEqual(response.status_code, 403)
        # should pass
        response = self.client.post(
            reverse(url), {"entity_id": self.entity1.id, "has_trading": "true"}
        )
        self.assertEqual(response.status_code, 200)
        entity = Entity.objects.get(id=self.entity1.id)
        ...
        # wrongly formatted
        response = self.client.post(
            reverse(url), {"entity_id": "blablabla", "has_trading": "false"}
        )
        self.assertEqual(response.status_code, 403)
        # no entity_id
        ...
        # entity I do not belong to
        response = self.client.post(
            reverse(url), {"entity_id": self.entity3.id, "has_trading": "false"}
        )
        self.assertEqual(response.status_code, 403)
        # should pass
        response = self.client.post(
            reverse(url), {"entity_id": self.entity1.id, "has_trading": "false"}
        )
        self.assertEqual(response.status_code, 200)
        entity = Entity.objects.get(id=self.entity1.id)
