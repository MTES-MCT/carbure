...
urlpatterns = [
    ...
    # private, operators
    path('operators/lots/declared', views.operators_lots, name='operators-api-declared-lots'),
    path('operators/lots/affiliated', views.operators_lots_affilies, name='operators-api-affiliated-lots'),
