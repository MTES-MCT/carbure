...
class LotsCertifMayhemTest(TestCase):
    ...
    def test_send_lot_with_vendor_certificate(self):
        ...
        lot = self.create_draft(production_site_commissioning_date="12/12/2012", vendor_certificate="TOTO", carbure_producer='', carbure_production_site='', unknown_producer="BIOFUEL GMBH")
    ...
    def test_send_lot_with_both_certificates(self):
        ...
        lot = self.create_draft(production_site_commissioning_date="12/12/2012", vendor_certificate="MY_CERTIFICATE", supplier_certificate="MY_SUPPLIER",  carbure_producer='', carbure_production_site='', unknown_producer="BIOFUEL GMBH")
