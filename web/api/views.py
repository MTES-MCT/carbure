...
def producers_lots_new(request, *args, **kwargs):
  ...
  'dae':l.dae, 'ea_delivery_date':l.ea_delivery_date.strftime('%d/%m/%Y'), 'ea_delivery_site':l.ea_delivery_site, 'ea_name':l.ea.name if l.ea else '', 'ea_id':l.ea.id if l.ea else None,
